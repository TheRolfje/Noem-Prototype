...
func choose_sub_quality(): #Logica para elegir que SubCualidad usar.
	if (data_entity.active_locomotional_state == State_Names.Locomocion.FLAT_TERRAIN):
		_start_this_sub_quality("agachado_normal")
